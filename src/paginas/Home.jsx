...
const Home = () => {
  ...
  return (
    <>
      <div className="md:mt-3 md:w-auto h-3/4">
        <Card>
          <h5 className="text-4xl font-bold tracking-tight text-blue-pastel-300 uppercase text-center">
            {profile.name?.substring(0, 12)} <span className="text-slate-600">{profile.name?.substring(13)}</span>
          </h5>
          ...
          <div className="flex justify-center">
            ...
            >
               <Tooltip
                content="Fuente de la imagen: Storyset - www.freepik.es"
                placement="bottom"
              >
              <img
                src={imgPresentacion}
          ...
          <div className="border-t-2 mt-1">
            <div className="flex gap-2 mt-2 justify-between">
              <span>
                <a href={profile.github} target="_blank"><FontAwesomeIcon icon={faGithub} size="xl" /></a>{' '}
                <a href={profile.linkedin} target="_blank"><FontAwesomeIcon
                  icon={faLinkedin}
                  size="xl"
              ...
              <span className="uppercase text-xs py-1 font-mono"><p>&copy; 2022 FJS</p></span>
              <span
